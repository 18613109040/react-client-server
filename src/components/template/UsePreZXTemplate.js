...
class UsePreZXTemplate extends Component {
 constructor(props){
   super(props);
   this.state={
     visible:true,
 ...
 render(){
   ...
   dataSource = [{item_name:'s'},{item_name:'2'}];
...
UsePreZXTemplate.contextTypes={
 router: React.PropTypes.object.isRequired
};
UsePreZXTemplate.defaultProps={
 dataSource:[],
 selectIndex:'',
 selectName:'',
 buttonClick:()=>{}
};
UsePreZXTemplate.propTypes = {
...
export default connect(mapStateToProps)(UsePreZXTemplate)
